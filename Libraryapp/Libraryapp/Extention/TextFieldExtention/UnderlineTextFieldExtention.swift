//
//  UnderlineTextFieldExtention.swift
//  Libraryapp
...
class UnderlineTextField : UITextField {
    ...
    func commonInit() {
        ...
        addTarget(self, action: #selector(UnderlineTextField.updateBorderColor), for: .editingDidBegin)
        addTarget(self, action: #selector(UnderlineTextField.updateBorderColor), for: .editingDidEnd)
        addTarget(self, action: #selector(UnderlineTextField.updateBorderColor), for: .editingDidEndOnExit)
    }
