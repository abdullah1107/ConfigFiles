...
//
//  Created by Fahim Rahman on 22/1/20.
...
/*
 ...
 checkInternet = try CheckingInternet.init()
 
 if  checkInternet!.connection != .unavailable {
...
public class CheckingInternet {
    ...
    public typealias NetworkReachable = (CheckingInternet) -> ()
    public typealias NetworkUnreachable = (CheckingInternet) -> ()
...
public extension CheckingInternet {
...
fileprivate extension CheckingInternet {
...
extension SCNetworkReachabilityFlags {
    ...
    typealias Connection = CheckingInternet.Connection
...
private class ReachabilityWeakifier {
    weak var reachability: CheckingInternet?
    init(reachability: CheckingInternet) {
